...
{
    public NormalRotate[] chairs;

    private VRCPlayerApi localPlayer;
    NormalRotate _localPlayerChair = null;

    public NormalRotate LocalPlayerChair
    {
        get
        {
    ...
    public bool IsWingsAssigned(NormalRotate chair)
    {
